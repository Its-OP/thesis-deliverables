"""Vendored copy of the SOAP optimizer from https://github.com/nikhilvyas/SOAP.

Source: https://raw.githubusercontent.com/nikhilvyas/SOAP/main/soap.py
Paper: https://arxiv.org/abs/2409.11321 (Vyas et al. 2024)
Vendored at: 2026-04-06 (upstream repo marked "preliminary implementation"
by the author — expect to re-vendor when an improved version lands with
lower-precision / distributed training support).

Vendored because SOAP is not distributed via PyPI. The class body is kept
verbatim so upstream bug fixes can be mirrored by replacing this file
wholesale. The factory that uses this class lives in
``part/utils/optimizers/__init__.py``.

DO NOT edit the SOAP class body in this file. Editable orchestration around
SOAP belongs in the factory or in the training scripts.
"""
import torch
